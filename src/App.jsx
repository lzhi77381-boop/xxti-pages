...
const QUESTIONS = [
  ...
  { id: 2, type: "锋利", question: "有人跟你说：「你这样的女孩，以后很难嫁出去。」你的反应是？", options: [
    { text: "反问他：「我为什么要以嫁出去为目标？」当场把这个前提拆了", scoring: [1, 2, -1, 2] },
    { text: "不动声色地笑一下，心里记下这个人以后少来往——不必争，把时间留给值得的人", scoring: [-2, 1, -1, -1] },
    { text: "认真想一下自己是不是哪里让人误会了，但不会为此改变自己——对方的标准不是我的标准", scoring: [-1, 0, -1, 0] },
    { text: "大方地说：「那正好，我也不想嫁给会说这种话的人家里的人。」", scoring: [2, -3, 3, -1] }
  ]},
  ...
  { id: 10, type: "锋利", question: "身边总有人说你「太要强了」「太有野心了」「女孩子不要那么拼」——你怎么看这件事？", options: [
    { text: "这是在告诉我：那些跟我共事的人，得先配得上我的野心。这是筛选器，不是缺陷", scoring: [2, 2, 1, 1] },
    { text: "「女孩子不要那么拼」背后的意思是「你不该赢」——问题不在我要强，问题在他们想要一个不要强的", scoring: [-1, 2, -2, 1] },
    { text: "我要强不是为了给谁看，也不是为了打败谁——我要强只是因为我想做到，评价是别人的事", scoring: [-2, -1, -1, -1] },
    { text: "笑一下就过了——连别人有野心都接受不了的人，本来就不在我要考虑的范围内", scoring: [1, -3, 2, -1] }
  ]},

...
const QUESTIONS = [
  ...
  { id: 10, type: "锋利", question: "有人半开玩笑地说：「我发现你这个人吧——不太合群。」说完还笑了笑，意思是「无恶意提醒」。你心里真正的反应是？", options: [
  ...
  { id: 17, type: "锋利", question: "一个你本以为属于自己的机会——升职、主导项目、重要评优——被给了一个明显不如你的同事。你怎么消化这件事？", options: [
    ...
    { text: "这件事提醒了我：等一个体系自己认出你，是这世界上最不划算的事情之一。以后我要把赌注押在看得见我的地方", scoring: [1, 1, 1, 3] },
